...
\begin{frame}{Evaluation of Alternative Strategies}{Building Collapse Rescue Methods}
  ...
  \newcolumntype{s}{>{\columncolor[HTML]{32CD32}} p{2.4cm}}
...
\begin{frame}{Evaluation of Alternative Strategies}{Robot Types}
  ...
  \setlength{\tabcolsep}{5pt}
  \renewcommand{\arraystretch}{1.2}
  \newcolumntype{s}{>{\columncolor[HTML]{32CD32}} p{3.55cm}}
  \arrayrulecolor[HTML]{000000}
...
\begin{frame}{Evaluation of Alternative Strategies}{Robot Locomotion}
  ...
  \setlength{\tabcolsep}{5pt}
  \renewcommand{\arraystretch}{1.2}
  \newcolumntype{s}{>{\columncolor[HTML]{32CD32}} p{2cm}}
  \arrayrulecolor[HTML]{000000}
...
\begin{frame}{Evaluation of Alternative Strategies}{Autonomous Quadcopter platforms}
  ...
  \hline
  &\includegraphics[scale=0.05]{DJI_Phanthom.jpg}&\includegraphics[scale=0.05]{Pixhawk.jpg}&\includegraphics[scale=0.08]{Parrot.jpg}&\includegraphics[scale=0.2]{Crazy_Flie_img.jpg}\\
  \hline
...
\item Implement the state estimation algorithm using an EKF.
...
\begin{frame}[allowframebreaks]
  ...
  \bibitem{Vision1}
    ...
    \newblock {\em in 2013 European Conference on Mobile Robots}
  ...
  \bibitem{Vision2}
    ...
    \newblock {\em Micromachines, vol. 6.}

  \bibitem{Lidar1}
    Lorenz Wellhausen, Renaud Dubé and  Abel Gawel,
    \newblock Reliable real-time change detection and mapping for 3D LiDARs,
    \newblock {\em Safety, Security and Rescue Robotics (SSRR)} 2017 IEEE International Symposium. 
  ...
  \bibitem{Lidar2}
    ...
    \newblock {\em Intelligent Robots and Systems (IROS)} 2017 IEEE/RSJ International Conference. 

  \bibitem{Sparse1}
    Kristopher R. Beevers and Wesley H. Huang,
    \newblock An Embedded Implementation of SLAM with Sparse Sensing,
    \newblock {\em Submitted the 2008 IEEE International Conference on Robotics \& Automation (ICRA 2008)}
    
  \bibitem{Sparse2}
    Paulo K. R. Beevers,
    \newblock Mapping with limited sensing,
    \newblock {\em PhD thesis, Rensselaer Polytechnic Institute, Troy, NY, January 2007}
